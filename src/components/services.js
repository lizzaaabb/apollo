    ...
    <div className='services-container'>
      ...
      <div className="service-wrapper">
        ...
        <div className="service-card">
          ...
          <p className='service-card-description'>Our e-commerce solutions are designed to help you sell more online. We offer a range of services, including custom storefront design, payment gateway integration, and inventory management.</p>
        </div>
        <div className="service-card">
          <div className="service-icon-wrap">
            <Icon variant={2} />
